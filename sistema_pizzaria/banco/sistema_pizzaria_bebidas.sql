...
CREATE TABLE `bebidas` (
  ...
  CONSTRAINT `bebidas_ibfk_1` FOREIGN KEY (`idPedido`) REFERENCES `pedidos` (`Cod_Pedido`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `bebidas` VALUES (1,'Coca-Cola 2L',1,1),(2,'Guaraná 1L',2,3),(3,'Água com Gás',1,4),(4,'Suco de Laranja 1L',1,5);
